...
const DcMemberTable = ({
    ...
    useEffect(() => {
        let allQueriedItems = allDCMemberItems.items.filter((datas) => {
            return datas
        })
        /** initial items  */
        //items collected
    ...
    const onRemoveUpload = () => {
        if (removeDetails.exId) {
            ...
            toast.promise(
                ...
                {
                    loading: 'deleting doctoral member',
                    success: (data) => `${data}`,
                    error: (err) => {
                        if (
                            err
                                                                ...
                                                                <Menu>
                                                                    ...
                                                                    <MenuList
                                                                        ...
                                                                        <MenuItem
                                                                            onClick={() =>
                                                                                routeNavigate(
                                                                                    `/m-examiners/dcmembers/view/${data._id}`
                                                                                )
                                                                            }>
                                                                            View
                                                                            Member
