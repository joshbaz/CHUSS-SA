...
const OpponentUpdateReport = ({ setFieldValue, values }) => {
        ...
        <FormContainer>
            <Box className='form_container'>
                ...
                <Stack
                    ...
                    spacing='15px'
                    h='100%'>
                    {values !== null && values.reportFile !== null ? (
                        ...
                        <Box className='formfields__Sfieldset'>
                            <Stack spacing='8px' className='form_wrap'>
                                <Text>
                                    Please upload the Examiner's report.
                                </Text>
...
export default OpponentUpdateReport
