...
const OpponentAAppointmentUpload = ({ setFieldValue, values }) => {
        ...
        <FormContainer>
            <Box className='form_container'>
                ...
                <Box className='formtitle'>
                    <h1>Opponent Appointment Letter</h1>
                </Box>
                    ...
                    {values.examinerAppLetter !== null ? (
                        <Box className='fileview'>
                            <Stack direction='row' alignItems='center' h='100%'>
                                ...
                                <Stack
                                    ...
                                    <Text>
                                        {values.examinerAppLetter.name}
                                        {values.examinerAppLetter.ext}
                                    </Text>
                                </Stack>
                            </Stack>
                        </Box>
                        ...
                        <Box className='formfields__Sfieldset'>
                            <Stack spacing='8px' className='form_wrap'>
                                <Text>
                                    Please upload the Opponent's general
                                    appointment letter.
                                </Text>
...
export default OpponentAAppointmentUpload
