...
const ProjectAOAppointmentUpload = ({ setFieldValue, values }) => {
        ...
        <FormContainer>
            <Box className='form_container'>
                ...
                <Box className='formtitle'>
                    <h1>Project Appointment Letter</h1>
                </Box>
                    ...
                    {values.projectAppLetter !== null ? (
                        <Box className='fileview'>
                            <Stack direction='row' alignItems='center' h='100%'>
                                ...
                                <Stack
                                    ...
                                    <Text>
                                        {values.projectAppLetter.name}
                                        {values.projectAppLetter.ext}
                                    </Text>
                                </Stack>
                            </Stack>
                        </Box>
                        ...
                        <Box className='formfields__Sfieldset'>
                            <Stack spacing='8px' className='form_wrap'>
                                <Text>
                                    Please upload the Opponent's appointment
                                    letter for this student.
                                </Text>
...
export default ProjectAOAppointmentUpload
