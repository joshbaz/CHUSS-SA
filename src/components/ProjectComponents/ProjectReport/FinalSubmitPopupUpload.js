...
const FinalSubmitPopupUpload = ({
    ...
    const validationSchema = yup.object().shape({
        finalsubmitfiles: yup.mixed().required('file is required'),
    ...
    const initialValues = {
        finalsubmitfiles: null,
        filetypename: '',
        othername: '',
    }

    const removeFiles = (setFieldValue) => {
        setFieldValue('finalsubmitfiles', null)
    }
                        ...
                        <Formik
                            ...
                            onSubmit={(values, helpers) => {
                                ...
                                toast.promise(
                                    ...
                                    {
                                        loading: 'uploading final submission files',
                                        success: (data) =>
                                            `${data}`,
                                        error: (err) => {
                                            if (
                                                                            ...
                                                                            <Stack
                                                                                ...
                                                                                <Box className='icon_wrap '>
                                                                                    <Stack
                                                                                        ...
                                                                                        spacing='0'
                                                                                        direction='column'
                                                                                        className={`icon_stack ${values.finalsubmitfiles.fileType}`}>
                                                                                        <Box>
                                                                                            <BsFileEarmark />
                                                                                        </Box>
                                                                                        <Text>
