...
const VivaPopupFileUpload = ({
    ...
    const validationSchema = yup.object().shape({
        vivafiles: yup.mixed().required('file is required'),
                    ...
                    <ModalBody p='0' w=''>
                        <Formik
                            ...
                            onSubmit={(values, helpers) => {
                                ...
                                toast.dismiss()
                                toast.promise(
                                    dispatch(updateVivaFiles(values2)).then(
                                        (res) => {
                                            //console.log('res', res)
                                            if (
                                                                            ...
                                                                            <Stack
                                                                                ...
                                                                                <Box className='icon_wrap '>
                                                                                    <Stack
                                                                                        ...
                                                                                        spacing='0'
                                                                                        direction='column'
                                                                                        className={`icon_stack ${values.vivafiles.fileType}`}>
                                                                                        <Box>
                                                                                            <BsFileEarmark />
                                                                                        </Box>
                                                                                        <Text>
...
export default VivaPopupFileUpload
