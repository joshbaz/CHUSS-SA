...
const GEAppointmentUpload = ({ setFieldValue, values }) => {
        ...
        <FormContainer>
            <Box className='form_container'>
                ...
                <Box className='formtitle'>
                    <h1>Examinar Appointment Letter</h1>
                </Box>
                ...
                <Stack
                    ...
                    spacing='15px'
                    h='100%'>
                    {values !== null && values.examinerAppLetter !== null ? (
                        ...
                        <Box className='formfields__Sfieldset'>
                            <Stack spacing='8px' className='form_wrap'>
                                <Text>
                                    Please upload the Examiner's general
                                    appointment letter.
                                </Text>
...
export default GEAppointmentUpload
