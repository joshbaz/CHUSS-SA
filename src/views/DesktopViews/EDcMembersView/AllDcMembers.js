...
import DcMemberTable from '../../../components/MExaminerDcMember/DcMemberTable'
        ...
        <Container direction='row' w='100vw' spacing={'0px'}>
            ...
            <Stack
                ...
                <Box w='100%' h='65px' zIndex={'20'}>
                    <TopBar
                        topbarData={{
                            title: 'Doctoral Committee Members',
                            count: null,
                        }}
                    />
                </Box>
